...
![no screenshot yet](https://img.shields.io/badge/figma-plugin-black) ![tests](https://img.shields.io/badge/tests-57-green)
...
npm test        # 57 files: integrity checks + behaviour
```
