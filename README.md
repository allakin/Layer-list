...
![no screenshot yet](https://img.shields.io/badge/figma-plugin-black) ![tests](https://img.shields.io/badge/tests-36-green)
...
npm test        # 36 files: integrity checks + behaviour
```
