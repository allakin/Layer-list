...
![no screenshot yet](https://img.shields.io/badge/figma-plugin-black) ![tests](https://img.shields.io/badge/tests-59-green)
...
npm test        # 59 files: integrity checks + behaviour
```
